...
void MDDARP_ResultInstance::addRoute(int vehicleId, const VehicleRoute& route) {
    routes[vehicleId] = route;
}

void MDDARP_ResultInstance::calculateViolations() {
...
std::string MDDARP_ResultInstance::generateSummaryString() const {
    std::stringstream ss;
...
void MDDARP_ResultInstance::displaySummary() {
    calculateViolations();
    std::cout << generateSummaryString() << std::endl;
}

void MDDARP_ResultInstance::saveToTxt(const std::string& filename) const {
...
void MDDARP_ResultInstance::saveToJSON(const std::string& filename) const {
