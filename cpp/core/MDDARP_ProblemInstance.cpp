...
void MDDARP_ProblemInstance::clear() {
    N_requests = 0;
    K_vehicles = 0;
    max_node_id = 0;
    P.clear();
...
bool MDDARP_ProblemInstance::loadFromJSON(const std::string& path) {
    clear();
...
void MDDARP_ProblemInstance::displayInfo() const {
    std::cout << "\n============================================\n";
    std::cout << "       MDDARP Problem Instance Info         \n";
    std::cout << "============================================\n";
...
void MDDARP_ProblemInstance::checkAndFixTriangleInequality(bool fixIt, bool verbose) {
